...
import { useGetHeroUserProps } from 'ui/mock/heroUser'
  ...
  <Story name="Profile page">
    ...
    >
      <User
        ...
        loadMoreLikes={useGetLoadMoreProps()}
        loadMoreCommunities={useGetLoadMoreProps()}
        loadMoreCollections={useGetLoadMoreProps()}
        loadMoreFollowing={useGetLoadMoreProps()}
        HeroUserBox={<HeroUser {...useGetHeroUserProps(true)} />}
        ActivityBoxes={[
          <ActivityPreview
            key="1"
