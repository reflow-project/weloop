...
import { useGetFeaturedCollectionsProps } from 'ui/mock/featuredCollections'
...
<Preview>
  <Story name="Discover page">
    ...
    >
      <Discover
        basePath={'/'}
        LoadMoreFormik={useGetLoadMoreProps()}
        FeaturedCommunitiesBox={<FeaturedCommunities {...getFeaturedCommunitiesProps(true)} />}
        FeaturedCollectionsBox={<FeaturedCollections {...useGetFeaturedCollectionsProps(true)} />}
        ActivitiesBox={
          <React.Fragment>
            <ActivityPreview
